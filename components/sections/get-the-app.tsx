      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mx-auto mb-8 max-w-2xl text-center">
          ...
          <p className="mt-3 text-balance text-base leading-6 text-muted-foreground">
            Join thousands of food lovers who are discovering new restaurants, making meaningful connections, and creating unforgettable dining experiences.
          </p>
        </div>
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <div className="group rounded-xl border border-border/60 bg-card p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-[#F55636]/30">
            ...
            <div className="mt-4">
              <a href="#download">
                <button className="bg-primary text-primary-foreground ring-2 ring-primary/60 shadow-lg hover:brightness-110 px-4 py-2 rounded-md">
                  Book Your Seat Now
                </button>
              </a>
            </div>
